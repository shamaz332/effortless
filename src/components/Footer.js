...
const Footer = () => {
  ...
  <div class="container mx-auto px-4">
    <div class="sm:flex sm:flex-wrap justify-center sm:-mx-4 md:py-4">
      <div class="px-10 sm:w-1/2 md:w-1/2 xl:w-1/2">
        ...
        <ul class="list-none footer-links">
          <li class="mb-8">
            <a href="#" class="text-2xl text_color">Getting Started</a>
          </li>
          <li class="mb-8">
            <a href="#" class="text-2xl text_color">Frequently asked questions</a>
          </li>       
          <li class="mb-8">
            <a href="#" class="text-2xl text_color">Tokens</a>
          </li>   
          <li class="mb-8">
            <a href="#" class="text-2xl text_color">Wallets</a>
          </li>     
        </ul>
      </div>
    ...
    <div class="list-none flex justify-between sm:w-full px-4 md:w-1/2">
            ...
            <a href="#" class="text-2xl text_color">Buy Crypto</a>
            <a href="#" class="text-2xl text_color">Blog</a>
            <a href="#" class="text-2xl text_color">Help</a>
            <a href="#" class="text-2xl text_color">Terms</a>
